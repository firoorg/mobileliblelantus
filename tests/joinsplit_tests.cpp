...
#include "../src//openssl_context.h"
#include "../src/joinsplit.h"
...
public:
    std::vector<PrivateCoin> GenerateCoins(std::vector<uint64_t> const &amounts) {
        ...
        for (auto a : amounts) {
            ...
            privs.emplace_back(params, serial, a, randomness, ecdsaKey, 46);
        }
